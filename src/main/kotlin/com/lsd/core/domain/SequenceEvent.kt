...
data class NoteLeft(val note: String, val ofComponent: ComponentName? = null) : SequenceEvent
data class NoteRight(val note: String, val ofComponent: ComponentName? = null) : SequenceEvent
...
data class ActivateLifeline(val component: ComponentName, var colour: String? = null) : SequenceEvent
data class DeactivateLifeline(val component: ComponentName) : SequenceEvent
